...
- [Neural_Network_with_Python.ipynb](Neural_Network_with_Python.ipynb): full implementation, training workflow, experiments, and results

## Why This Project Matters

This project shows that I can go beyond calling prebuilt ML libraries. I can understand the mechanics of a model, implement the training logic myself, evaluate performance rigorously, and improve results through systematic experimentation. That combination is directly relevant to data science roles that value strong foundations, analytical thinking, and hands-on technical execution.
